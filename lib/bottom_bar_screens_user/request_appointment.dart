...
import '../bottom_nav_bar_user/common_app_bar_user.dart';
...
class _RequestAppointmentScreenState extends State<RequestAppointmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildAppBarUser(_scaffoldKey, context, -3),
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          flex: 5,
                          child: InputDecorator(
                            decoration: myInputDecoration(hintText: 'Date'),
                            isEmpty: _day == null,
                            child: DropdownButton(
                              isExpanded: true,
                              value: _day,
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          flex: 5,
                          child: InputDecorator(
                            decoration: myInputDecoration(hintText: 'Timeslot'),
                            isEmpty: _day == null,
                            child: DropdownButton(
                              isExpanded: true,
                              value: _timeslot,
                              ...
                              onChanged: (String? newValue) {
                                setState(() {
                                  ...
                                  dropDownTimeslot = false;
                                });
                              },
                              items: dropdownItemsTimeslot,
                            ),
                          ),
                        ),
                      ],
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          flex: 5,
                          child: InputDecorator(
                            decoration: myInputDecoration(hintText: 'Topic'),
                        ...
                        Expanded(
                          ...
                          child: InputDecorator(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return 'Please Enter Brief Info';
                                }
                              },
                              maxLines: 2,
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            try {
                              ...
                              DateTime dateForSession =
                                  DateTime.now().next(nextDay);
                              //EasyLoading.show(status: 'Adding Scheme!');
                              String uid =
                              ...
                              String docId = await FirebaseFirestore.instance
                                ...
                                'long': controller
                                        .schools[controller.schoolIndex.value]
                                    ['long'],
                                'topic': requestController.text.trim(),
                              ...
                              await FirebaseFirestore.instance
                                ...
                                'timeslot': _timeslot,
                                'topic': requestController.text.trim(),
                                'brief_info': roiController.text.trim(),
                                'timestamp': DateTime.now(),
                                'user_id': uid,
                                'status': 'pending',
                                'doc_id': docId
