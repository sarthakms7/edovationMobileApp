...
class StatsScreenSchool extends StatefulWidget {
  String schoolId;
  StatsScreenSchool({Key? key, required this.schoolId}) : super(key: key);

  @override
  _StatsScreenSchoolState createState() => _StatsScreenSchoolState();
}

class _StatsScreenSchoolState extends State<StatsScreenSchool> {
        ...
        child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              ...
              var totalKindnessPoints =
                  snapshot.data.docs[0]['number_of_sessions'] * 10 +
                      snapshot.data.docs[0]['number_of_books_donated'] * 10;
              return Column(
                children: [
                  Table(
                    ...
                    children: [
                      TableRow(decoration: BoxDecoration(), children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(
                            snapshot.data.docs[0]['number_of_sessions']
                                .toString(),
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                      ...
                      TableRow(children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(
                            snapshot.data.docs[0]['number_of_books_donated']
                                .toString(),
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
